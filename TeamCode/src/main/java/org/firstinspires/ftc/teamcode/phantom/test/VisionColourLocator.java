...
public class VisionColourLocator extends LinearOpMode
{
    public void runOpMode()
    {
        ...
        while (opModeIsActive() || opModeInInit())
        {
            ...
            telemetry.addLine(" Area Density Aspect  Center Area");

            // Display the size (area) and center location for each Blob.
            for(ColorBlobLocatorProcessor.Blob b : blobs)
            {
                RotatedRect boxFit = b.getBoxFit();
                telemetry.addLine(String.format(Locale.ROOT, "%5d  %4.2f   %5.2f  (%3d,%3d) %3f",
                        b.getContourArea(), b.getDensity(), b.getAspectRatio(), (int) boxFit.center.x, (int) boxFit.center.y, boxFit.size.area())
                );
            }
